...
dotnet new webapp -o vslive23Web
...
# az ad sp create-for-rbac --name "vslive23-demos-SPN" --sdk-auth
...
az deployment sub create --name vslive23 --location eastus --template-file ./infra/arm/main.bicep 
...
# Cleanup 
az group delete --name vslive23-arm-rg
az group delete --name vslive23-bicep-rg
pulumi down
terraform destroy
az group delete --name vslive23-ansible-rg